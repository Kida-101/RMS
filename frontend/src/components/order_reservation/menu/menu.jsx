        ...
        {/* <form class="max-w-md mx-auto">
          ...
          <div class="relative">
            ...
            <input
              type="search"
              id="default-search"
              className="w-full p-2 pl-9 pr-10 mt-4 block p-3 ps-10 text-sm text-gray-900 border-2 outline-none border-gray-300 rounded-[50px] bg-transparent focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
